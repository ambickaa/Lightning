({
	loadSalesdashboard : function(component,event){
       ...
       console.log('*********************************'+String((radlCoverage[chartIdentfier].totalCoverageMap['Develop']).indexOf(':')) == -1);
        //debugger
		var data = {            
            //labels:['# Accounts','Current Sales','Growth Potential','Programs Planned','AVG Programs'],
            ...
            datasets: [
                {
                    ...
                    data:[ String((radlCoverage[chartIdentfier].totalCoverageMap['Develop']).indexOf(':')) == -1?
            			...
            			//  parseInt(radlCoverage[chartIdentfier].currentSalesMap['Develop'].split(':')[1]) : 0,
                         
                       //   String((radlCoverage[chartIdentfier].growthPotentialMap['Develop']).indexOf(':') != -1 ) ? 
            			//  parseInt(radlCoverage[chartIdentfier].growthPotentialMap['Develop'].split(':')[1]) : 0,
                ...
                },
                {
                    ...
                    data:[String((radlCoverage[chartIdentfier].totalCoverageMap['Acquire']).indexOf(':')) == -1?
            			 ...
            			 // parseInt(radlCoverage[chartIdentfier].currentSalesMap['Acquire'].split(':')[1]) : 0,
                         
                         // String((radlCoverage[chartIdentfier].growthPotentialMap['Acquire']).indexOf(':') != -1 ) ? 
            			 // parseInt(radlCoverage[chartIdentfier].growthPotentialMap['Acquire'].split(':')[1]) : 0,
                ...
                },
                {
                    ...
                    data:[
                        ...
                        String((radlCoverage[chartIdentfier].totalCoverageMap['Retain']).indexOf(':')) == -1?
            			 ...
            			 // parseInt(radlCoverage[chartIdentfier].currentSalesMap['Retain'].split(':')[1]) : 0,
                         
                         // String((radlCoverage[chartIdentfier].growthPotentialMap['Retain']).indexOf(':') != -1 ) ? 
            			 // parseInt(radlCoverage[chartIdentfier].growthPotentialMap['Retain'].split(':')[1]) : 0,
                ...
                },
                {
                    ...
                    data:[String((radlCoverage[chartIdentfier].totalCoverageMap['Light Touch']).indexOf(':')) == -1?
            			 ...
            			 // parseInt(radlCoverage[chartIdentfier].currentSalesMap['Light Touch'].split(':')[1]) : 0,
                         
                         // String((radlCoverage[chartIdentfier].growthPotentialMap['Light Touch']).indexOf(':') != -1 ) ? 
            			 // parseInt(radlCoverage[chartIdentfier].growthPotentialMap['Light Touch'].split(':')[1]) : 0,
